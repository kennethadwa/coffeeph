  ...
  <header class="py-5" style="background: #361500;">
    <div class="container px-4 px-lg-5 my-5">
      <div class="text-center text-white">
        ...
        <p class="lead fw-normal text-white-50 mb-0">Update your information below</p>
      </div>
    </div>
  </header>
              ...
              <form method="POST" action="profile.php">
                <div class="row mb-3">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="firstName" name="firstName" value="<?php echo htmlspecialchars($user['first_name']); ?>" />
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row mb-3">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="contactNumber" name="contactNumber" value="<?php echo htmlspecialchars($user['contact']); ?>" />
                  </div>
                  <div class="col-md-6">
